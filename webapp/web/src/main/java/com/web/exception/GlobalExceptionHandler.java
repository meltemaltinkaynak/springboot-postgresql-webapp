...
//	}
	...
	public ResponseEntity<Map<String, Object>> handleBaseException(BaseException exception, WebRequest request) {

	    Map<String, Object> response = new HashMap<>();
	    Map<String, String> exceptionMap = new HashMap<>();

	    // mesaj tipi alınır
	    MessageType type = exception.getErrorMessage().getMessageType();

	    // JSON yapısını doldur
	    exceptionMap.put("code", type.name()); // veya type.getCode() istersen
	    exceptionMap.put("message", type.getMessage());

	    response.put("exception", exceptionMap);
