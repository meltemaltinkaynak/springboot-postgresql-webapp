document.addEventListener("DOMContentLoaded", async function () {
    ...
    async function currentUser() {
        try {
            ...
            if (userProfile) {
                populateEditModal(userProfile);  // Modalda göster
            }
    ...
    function populateEditModal(userProfile) {
        // Eğer profil fotoğrafı varsa, fotoğrafı gösterebiliriz
    ...
    document.getElementById("edit-icon").addEventListener("click", async function () {
        ...
        // Modal'ı aç
        document.getElementById("edit-modal").style.display = "block";  // Modal'ı açmak için display: block
    });

    // Modalı kapatmak için "X" işaretine tıklama
    document.getElementById("close-modal").addEventListener("click", function () {
        document.getElementById("edit-modal").style.display = "none";  // Modal'ı kapat
    });

    // Modal dışında bir yere tıklanınca kapat
    window.addEventListener("click", function (event) {
        console.log("Modal dışına tıklanmış mı?", event.target === document.getElementById("edit-modal"));  // Log ekledim
    ...
    function validateFirstName(firstName) {
        if (!firstName || firstName.trim() === "") {
            showToastMessage("Ad alanı boş bırakılamaz.", false); // Hata mesajı toast
            return false;
