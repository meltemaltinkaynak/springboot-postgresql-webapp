    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers("/contents/last-week").authenticated()  // Yorumları sadece giriş yapmış kullanıcılar görmeli
                                .requestMatchers("/contents/webdesign").authenticated()   // Tüm webtasarım içeriklerini giriş yapmış kullanıcılar
                                .requestMatchers("/contents/public/**").permitAll()  // Kısıtlı  webtasarım içeriklerini tüm kullanıcılar
