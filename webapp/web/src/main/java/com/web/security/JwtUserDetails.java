...
public class JwtUserDetails implements UserDetails {
	    ...
	    private JwtUserDetails(Long id, String email, String password, GrantedAuthority authority,boolean enabled) {
	        this.id = id;
	        this.email = email;
	    ...
	    public static JwtUserDetails create(User user) {
	        ...
	        return new JwtUserDetails(user.getId(), user.getEmail(), user.getPassword(), authority, user.isEnabled());
	    }
