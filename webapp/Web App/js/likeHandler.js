...
// Beğeni butonuna tıklandığında işlemi yöneten fonksiyon
...
// Beğeni sayısını API'den alan fonksiyon
...
// Dinamik olarak yeni içerikler eklendiğinde beğeni durumlarını tekrar kontrol eden fonksiyon
function observeContentChanges() {
    const observer = new MutationObserver(() => {
        console.log("Yeni içerikler eklendi, beğeni durumları kontrol ediliyor...");
        checkUserLikeStatuses();
    });
